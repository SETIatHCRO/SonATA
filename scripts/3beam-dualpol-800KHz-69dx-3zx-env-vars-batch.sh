...
#NOTE: seti000-1 has a bad 10GbE port. Using seti000-2
#JR - Chan1x,y still failing. For the night of Aug 17, try swapping hosts for chan1 and chan2
CHANHOST1X="seti000-1"
CHANHOST2X="seti014-1"
CHANHOST3X="seti002-1"
CHANHOST1Y="seti000-1"
CHANHOST2Y="seti014-1"
