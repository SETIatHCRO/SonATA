...
OrderedTargets * prepareOrderedTargets(MYSQL *db, MYSQL* dbTargets);
...
int main(int argc, char *argv[])
{
   ...
   string databaseHost("sse100");
   string databaseName("testtemp");
   ...
   try {
      ...
      MYSQL* dbTargets = connectToDatabase(databaseHost, "targets");
      ...
      OrderedTargets *orderedTargets = prepareOrderedTargets(db, dbTargets);
...
// habcat et al.
   ...
   std::list<string> pastDbNames;
   pastDbNames.push_back("sonata201503");
   pastDbNames.push_back("sonata201502");
   pastDbNames.push_back("sonata201501");

   pastDbNames.push_back("exoplanets8ghz");
	   pastDbNames.push_back("galcenter");
	   pastDbNames.push_back("galcenter2");
	   pastDbNames.push_back("kepler6667mhz");
	   pastDbNames.push_back("kepler6867mhz");
	   pastDbNames.push_back("kepler8960mhz");
	   pastDbNames.push_back("kepler8ghz");
	   pastDbNames.push_back("ldn1622_1500");
	   pastDbNames.push_back("sonata_obs_2013_11");
