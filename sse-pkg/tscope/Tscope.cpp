...
void Tscope::reportTargetTracking()
{
   ...
   //cout << "reportTargetTracking():\n"
	    //"maxPointingErrDeg = " << maxPointingErrorDeg() << endl;
	    //
   //JR - Mar 05, 2016 - changed from 10 to 30. Also make backend server report every 5 secs, up from 10.
   //JR - Mar 11, 2016 - changed from 30 to 20. Ik think it was not catching bad antennas, 30 threshold is too high.
   //This makes things more responsive.
   const int maxNotTrackingTargetCount = 20;
