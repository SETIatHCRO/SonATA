					...
					void *bodybuff)
{
   ...
   if(hdr->code != TSCOPE_STATUS_MULTIBEAM)
   {
   	//SseArchive::SystemLog() << "INCOMING:" << SseTscopeMsg::getMessageCodeString(hdr->code) << ": " << *hdr << endl;
   }
   ...
   case TSCOPE_ERROR:
      //SseArchive::SystemLog() << "TSCOPE_ERROR" << endl;
   ...
   case TSCOPE_MESSAGE:
      //SseArchive::SystemLog() << "TSCOPE_MESSAGE" << endl;
      nssMessagePtr = static_cast<NssMessage *>(bodybuff);
      nssMessagePtr->demarshall();
      siteTscopeManager_->processNssMessage(this, *nssMessagePtr);
   ...
   case TSCOPE_INTRINSICS:
      //SseArchive::SystemLog() << "TSCOPE_INTRINSICS" << endl;
   ...
   case TSCOPE_TRACKING_ON:
      ...
      //SseArchive::SystemLog() << "TSCOPE_TRACKING_ON" << endl;
   ...
   case TSCOPE_TRACKING_OFF:
      ...
      ///SseArchive::SystemLog() << "TSCOPE_TRACKING_OFF" << endl;
   ...
   case TSCOPE_READY:
      ...
      //SseArchive::SystemLog() << "TSCOPE_READY" << endl;
   ...
   case TSCOPE_CANCEL_TIMER:
      ...
      //SseArchive::SystemLog() << "TSCOPE_CANCEL_TIMER" << endl;
   ...
   default: 
      //SseArchive::SystemLog() << "UNEXPECTED_CODE_RECEIVED: " << "Tscope unexpected message code received: "
//	                    << hdr->code << endl;
      VERBOSE2(getVerboseLevel(), 
